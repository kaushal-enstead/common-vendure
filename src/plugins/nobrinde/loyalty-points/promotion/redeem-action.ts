...
import { redeemActionCode } from '../constants';

let connection: TransactionalConnection;
export const redeemLoyaltyPointAction = new PromotionItemAction({
  ...
  execute: async (ctx, orderLine, args, state) => {
    ...
    const loyaltyDiscount = seller?.loyaltySetting?.loyaltyDiscount;
