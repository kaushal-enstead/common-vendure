    ...
    configuration: config => {
        config.customFields.Seller.push({
            ...
            label: [
                ...
                { languageCode: LanguageCode.pt, value: 'UUID Conta gateway de pagamentos' },
                { languageCode: LanguageCode.pt_PT, value: 'UUID Conta gateway de pagamentos' },
            ],
            description: [
                { languageCode: LanguageCode.en, value: 'The ID used to process connected payments' },
                { languageCode: LanguageCode.pt, value: 'O ID usado para processar pagamentos conectados' },
                { languageCode: LanguageCode.pt_PT, value: 'O ID usado para processar pagamentos conectados' },
            ],
            type: 'string',
            public: false,
        });
